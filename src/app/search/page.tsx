...
export default function Search() {
    ...
    //yeh helper functon se search page pe bhi delete kiya toh turant update hota hai . update in the sense delete wala nikal jayega !!
    //apan helperfunction matlab search function hi ha : search karege or output dega : toh delete karne ke bad apan ne wapas search function chalaya samjo!
