...
export default function SingleBlog({blogItem , handleDelete} : {blogItem : Blog, handleDelete :(id:number)=>{}}){ //yeh parameter ka explaination {blogItem}(yeh ider receive hoga via props) : {blogItem}(yeh name e aayega) : {Blog}(yeh uska type , typescript hai samjo)
        //destructre kar rahe hai ider
            ...
            <div>
              ...
              <div className="p-6 sm:p-8 md:py-8 md:px-6 lg:p-8 xl:py-8 xl:px-5 2xl:p-8">
                <h3>
                 ...
                 {/* h-[20px]
            This sets the height of the element to 20 pixels. The content inside the element will be restricted to this height. 
            2. text-ellipsis
            This applies the ellipsis (...) effect to the text. If the text overflows the width of the container, an ellipsis (...) will be shown at the end to indicate the overflow. */}
